...
<body>
    ...
    <nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="#contact" class="w3-bar-item w3-button w3-hover-white">Showcase</a>
            <a href="#contact" class="w3-bar-item w3-button w3-hover-white">Services</a>
            <a href="#contact" class="w3-bar-item w3-button w3-hover-white">Packages</a>
            <a href="#contact" class="w3-bar-item w3-button w3-hover-white">Contact</a>
            <a href="{{ url('/usuarios') }}" class="w3-bar-item w3-button w3-hover-white">Usuarios </a>
